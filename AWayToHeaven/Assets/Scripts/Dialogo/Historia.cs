...
public class Historia : MonoBehaviour
{
    ...
    string s14 = "¿Y ahora qué hago? este sitio no tiene muy buena pinta… ¿Tengo que quedarme aquí para siempre? Ohhh… ya puedo sentir cómo me empiezo a volver loco.";
    string s15 = "¡Tú! vas a torturarme ¡¿es eso?! ¿Qué he hecho yo para merecer estar aquí? Si es por lo de Mateo no iba en serio, ¡solo bromeábamos!";
    ...
    string s16 = "ES LA PRIMERA VEZ QUE MUERO YO.";
    ...
    string s18 ="Escucha, Clavis, tiene que haber una forma de salir de aquí, esto tiene que ser una especie de prueba, no puedo haber acabado en el infierno, ¡no tiene ningún sentido!";
    string c12 = "Mira que eres insistente, si quieres respuestas ve a hablar con el jefe, si es que te atreves.";
    string s19 = "...";
    string s20 = "¿Si me atrevo?";
    string c13 = "¡Por supuesto! Hacen falta agallas para atravesar este lugar y llegar a él…";
    string c14 = "Mira, tengo una propuesta para ti. Si estás tan seguro de que esto es un error, yo puedo llevarte, y ya tú negocias con el jefe, a ver si así resuelves tus dudas.";
    ...
    string s21 = "...";
    string s22 = "¡Sí sí, claro que trato hecho!"; 
    string c17 = "Heheheh… ¡Genial! Me alegra hacer tratos contigo… ¿Cómo decías que te llamabas?";
    string s23 = "Elías, me llamo Elías. Como el profeta.";
    string c18 = "Mucho gusto Eli, pues como me has caído bien te voy a contar cómo va a funcionar esto.";
    string s24 = "Elías… mejor llámame Elías.";
    string s25 = "Eli es nombre de niña...";
    string c19 = "...";
    string c20 = "Bueno Eli, te explico:";
    string c21 = "El jefe se encuentra dos plantas por encima de esta. En realidad, preferimos llamarlo anillos en vez de plantas, suena mucho mejor, tiene más gancho.";
    string c22 = "Cada anillo está formado por unas cuantas salas, por las cuales te podrás mover gracias a mi ayuda y mis llaves.";
    string c23 = "Cuando llegues a la puerta de cada sala yo te la abriré, para que puedas ir a alguna de las de alrededor.";
    string c24 = "En una de estas salas habrá unas escaleras por las que podrás subir al siguiente anillo, así que céntrate en llegar hasta allí.";
    string c25 = "Tengo amigos en muchas de estas salas, pero ten cuidado, a veces se ponen un poco… agresivos. Ya te los iré presentando.";
    string c26 = "Además, tengo algunas sorpresas preparadas en ciertas salas para darle un poco de sabor a este viaje, al fin y al cabo ¡esta es mi forma de divertirme! Es tu decisión cuánto quieras investigar.";
    string c27 = "Cuando hayas superado los dos anillos podrás hablar con el jefe. ¡Venga Eli a trabajar, que aún no es Domingo!";
    string c28 = "No hace falta que lo diga, pero no te preocupes por morir, solo dolerá un montón pero ahí estaré para volver a recibirte HA HA HA.";
    string c29 = "¡Ah! ¡Casi se me olvidaba! Te voy a dar una pequeña ayudita para hacer esto más divertido.";
    string c30 = "¿Ves que tus manos ahora están verdes? Pues prueba a acercarte a alguno de mis amigos, a ver qué pasa…";
   ...
   public string z1 = "Uf menos mal, otra sala tranquila. Ya no podía más.";
    ...
    void Start()
    {
        ...
        Sala1.Add(s13); Sala1.Add(s14); Sala1.Add(s15); Sala1.Add(c9); Sala1.Add(s16); Sala1.Add(c10); Sala1.Add(s17); Sala1.Add(c11); Sala1.Add(s18); Sala1.Add(c12); Sala1.Add(s19); Sala1.Add(s20);
        Sala1.Add(c13); Sala1.Add(c14); Sala1.Add(c15); Sala1.Add(c16); Sala1.Add(s21); Sala1.Add(s22); Sala1.Add(c17); Sala1.Add(s23); Sala1.Add(c18); Sala1.Add(s24); Sala1.Add(s25); Sala1.Add(c19); Sala1.Add(c20); Sala1.Add(c21); 
        Sala1.Add(c22); Sala1.Add(c23); Sala1.Add(c24); Sala1.Add(c25); Sala1.Add(c26); Sala1.Add(c27); Sala1.Add(c28); Sala1.Add(c29); Sala1.Add(c30);
        ...
        TextoElias.Add(s24); TextoElias.Add(s25);
